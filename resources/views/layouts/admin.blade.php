        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
              ...
              with font-awesome or any other icon font library -->
                        ...
                        {{-- Rekap Transaksi --}}
                        <li class="nav-item">
                            <a href="{{ url('transaction_summaries') }}"
                                class="nav-link {{ request()->is('transaction_summaries') ? 'active' : '' }}">
            ...
            methods: {
                getPageTitle() {
                    ...
                    if (currentPage.endsWith('/products')) {
                        ...
                        // untuk atasi yang membawa id
                    } else if (currentPage.includes('/products/') && currentPage.endsWith('/create')) {
                        this.pageTitle = 'Buat Produk';

                        // membawa id
                    } else if (currentPage.includes('/products/') && currentPage.endsWith('/edit')) {
                    ...
                    } else if (currentPage.endsWith('/transactions/create')) {
                        this.pageTitle = 'Buat Transaksi';

                        // atasi yang membawa id
                    } else if (currentPage.includes('/transactions/') && !isNaN(currentPage.split('/').pop())) {
                        this.pageTitle = 'Detail Transaksi';

                        // atasi membawa id
                    } else if (currentPage.includes('/transactions/') && currentPage.endsWith('/edit')) {
                        this.pageTitle = 'Edit Transaksi';

                    } else if (currentPage.endsWith('/store')) {
                        this.pageTitle = 'Data Supplier';
                    } else if (currentPage.includes('/store/') && !isNaN(currentPage.split('/').pop())) {
                        this.pageTitle = 'Data Detail Supplier';
                    } else if (currentPage.includes('/note_buyer/') && !isNaN(currentPage.split('/').pop())) {
                        this.pageTitle = 'Data Nota Supplier';
