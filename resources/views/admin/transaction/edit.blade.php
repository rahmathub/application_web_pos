...
@section('header', 'Edit Transaksi Produk')
        ...
        <form method="POST" action="{{ url('transactions/' . $transaction->id) }}">
            ...
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <select name="customer_id" data-placeholder="Pilih Pembeli" class="form-control">
                            @foreach($costumerName as $customer)
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <div class="input-group date" id="reservationdatetime" data-target-input="nearest">
                            <input name="transaction_datetime" type="text" class="form-control datetimepicker-input" data-target="#reservationdatetime" value="{{ $transaction->transaction_datetime ? date('m/d/Y/H:i'  , strtotime($transaction->transaction_datetime)) : '' }}" />
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <select name="product_id[]" class="select2" multiple="multiple" data-placeholder="Pilih Produk" style="width: 100%;" required onchange="showQuantityInputs(this)">
                            @foreach($products as $product)
                                <option value="{{ $product->id }}" {{ in_array($product->id, $selectedProductIds) ? 'selected' : '' }} data-price="{{ $product->price_deal }}">
                                    {{ $product->name }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="number" class="form-control" id="totalPayment" name="price_total" value="{{ $transaction->price_total }}" required readonly>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="number" class="form-control" id="receivedMoney" name="accept_customer_money" value="{{ $transaction->accept_customer_money }}" required>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control" id="changeMoney" value="{{ $transaction->change_customer_money }}" required readonly>
                        <input type="hidden" id="changeMoneyHidden" name="change_customer_money" value="{{ $transaction->change_customer_money }}">
                    </div>
                </div>
            </div>
            <!-- /.card-body -->
